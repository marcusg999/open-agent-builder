...
export const MacbookScroll = ({
  ...
  const screenFadeOut = useTransform(scrollYProgress, [0.3, 1], [1, 0]); // Added screen fade out effect
  ...
  return (
    ...
    >
      ...
      >
        {title || (
          <span>
            Scroll to see the magic <span className="text-neutral-500">👇</span>
          </span>
        )}
      </motion.h2>
      {/* Lid */}
...
export const Lid = ({
  ...
  rotate,
  translate,
  screenFadeOut, // Added screenFadeOut prop
  src,
}: {
  ...
  screenFadeOut: MotionValue<number>; // Added screenFadeOut type
  src?: string;
}) => {
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        style={{
          ...
          opacity: screenFadeOut, // Applied screenFadeOut effect
          transformStyle: "preserve-3d",
          transformOrigin: "top",
        }}
